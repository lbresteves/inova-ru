...
class MemoryRepository:
    ...
    def seed(self) -> None:
        ...
        self.add_meal("12345678901", "0003", RESTAURANTS["0003"], 1, cents("2.40"), False)
    ...
    def add_meal(
        ...
        if not gratuidade:
            if valor_total_cents > user.balance_cents:
                raise ValueError("Insufficient balance.")
            user.balance_cents -= valor_total_cents
    ...
    def create_payment(self, cpf: str, amount_cents: int) -> Payment:
        ...
        payment = Payment(
            ...
            qr_code=payload,
            qr_code_base64=qr_png_base64(payload),
