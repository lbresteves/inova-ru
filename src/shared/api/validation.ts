...
export function readString(record: Record<string, unknown>, key: string, path = key): string {
...
export function readNumber(record: Record<string, unknown>, key: string, path = key): number {
  const value = record[key];
...
export function readBoolean(record: Record<string, unknown>, key: string, defaultValue?: boolean): boolean {
  const value = record[key];
...
export function readDateString(record: Record<string, unknown>, key: string): string {
